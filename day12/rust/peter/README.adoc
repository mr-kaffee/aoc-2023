...
The key to solve part 2 in a reasonable time was to add caching of partial results. So if `check_recursive` is called on something that had been calculated before, recursion is broken and the cached result is returned.
